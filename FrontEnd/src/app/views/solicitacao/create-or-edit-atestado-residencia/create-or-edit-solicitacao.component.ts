...
@Component({
  selector: 'create-or-edit-solicitacao',
  templateUrl: './create-or-edit-solicitacao.component.html',
  styleUrls: ['./create-or-edit-solicitacao.component.css'],
})
export class CreateOrEditSolicitacaoComponent implements OnInit {
